  ...
  return (
    ...
    <section className='containerabout' style={{ backgroundImage: `url(${Aboutpic})`, backgroundSize: 'cover'}}>
      ...
      <div className='subBoxText'>
        ...
        <p>I am Thays with 28 years old, Brazilian, living in California - USA, skilled software developer, since January 2020, with experience in several areas (as sales, advocacy, administrative, cleaning, banking, aupair exchange program ), looking for the first job as developer.</p>
